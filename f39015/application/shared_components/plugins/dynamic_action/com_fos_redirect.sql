...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(7316748033401531455)
...
,p_reference_id=>51407301121328388766
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316748350720531456)
,p_plugin_id=>wwv_flow_api.id(7316748033401531455)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316748786201531456)
,p_plugin_attribute_id=>wwv_flow_api.id(7316748350720531456)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316749283725531456)
,p_plugin_attribute_id=>wwv_flow_api.id(7316748350720531456)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316749787214531456)
,p_plugin_id=>wwv_flow_api.id(7316748033401531455)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(7316748350720531456)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316750100619531457)
,p_plugin_id=>wwv_flow_api.id(7316748033401531455)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316750511912531457)
,p_plugin_id=>wwv_flow_api.id(7316748033401531455)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316751941114531457)
,p_plugin_attribute_id=>wwv_flow_api.id(7316750511912531457)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316750933348531457)
,p_plugin_attribute_id=>wwv_flow_api.id(7316750511912531457)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316751466950531457)
,p_plugin_attribute_id=>wwv_flow_api.id(7316750511912531457)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316752402347531458)
,p_plugin_id=>wwv_flow_api.id(7316748033401531455)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(7316750511912531457)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316752858268531458)
,p_plugin_id=>wwv_flow_api.id(7316748033401531455)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316753212195531458)
,p_plugin_id=>wwv_flow_api.id(7316748033401531455)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316753650607531458)
,p_plugin_attribute_id=>wwv_flow_api.id(7316753212195531458)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316754168333531458)
,p_plugin_attribute_id=>wwv_flow_api.id(7316753212195531458)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316754678699531459)
,p_plugin_id=>wwv_flow_api.id(7316748033401531455)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316755034890531459)
,p_plugin_id=>wwv_flow_api.id(7316748033401531455)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316755467974531459)
,p_plugin_id=>wwv_flow_api.id(7316748033401531455)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(7316757957929531461)
,p_plugin_id=>wwv_flow_api.id(7316748033401531455)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(7316758308702531461)
,p_plugin_id=>wwv_flow_api.id(7316748033401531455)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(7316758722556531461)
,p_plugin_id=>wwv_flow_api.id(7316748033401531455)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(7316759111051531461)
,p_plugin_id=>wwv_flow_api.id(7316748033401531455)
