...
begin
--   Manifest
--     PLUGIN: COM.FOS.MESSAGE_ACTIONS
--   Manifest End
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(7316695671441531428)
,p_plugin_type=>'DYNAMIC ACTION'
,p_name=>'COM.FOS.MESSAGE_ACTIONS'
,p_display_name=>'FOS - Message Actions'
,p_category=>'EXECUTE'
,p_supported_ui_types=>'DESKTOP:JQM_SMARTPHONE'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('DYNAMIC ACTION','COM.FOS.MESSAGE_ACTIONS'),'')
...
,p_reference_id=>51349259795381868869
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316695979393531428)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316696352506531428)
,p_plugin_attribute_id=>wwv_flow_api.id(7316695979393531428)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316696890346531428)
,p_plugin_attribute_id=>wwv_flow_api.id(7316695979393531428)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316697369090531429)
,p_plugin_attribute_id=>wwv_flow_api.id(7316695979393531428)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316697879532531429)
,p_plugin_attribute_id=>wwv_flow_api.id(7316695979393531428)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316698359457531429)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
,p_attribute_scope=>'COMPONENT'
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(7316695979393531428)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316698719716531429)
,p_plugin_attribute_id=>wwv_flow_api.id(7316698359457531429)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316699267569531429)
,p_plugin_attribute_id=>wwv_flow_api.id(7316698359457531429)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316699754764531430)
,p_plugin_attribute_id=>wwv_flow_api.id(7316698359457531429)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316700248381531430)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_attribute_id=>wwv_flow_api.id(7316698359457531429)
,p_depending_on_has_to_exist=>true
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316700689173531430)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316700951151531430)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316701386093531431)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316701751563531431)
,p_plugin_attribute_id=>wwv_flow_api.id(7316701386093531431)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316702254090531431)
,p_plugin_attribute_id=>wwv_flow_api.id(7316701386093531431)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316702728657531431)
,p_plugin_attribute_id=>wwv_flow_api.id(7316701386093531431)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316703222317531431)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(7316701386093531431)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'IN_LIST'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316703643576531432)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316704014582531432)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
,p_attribute_scope=>'COMPONENT'
...
,p_unit=>'seconds'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(7316703643576531432)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316704412059531432)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316704808672531432)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(7316708285596531435)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(7316708607799531435)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(7316709048089531435)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(7316709434517531436)
,p_plugin_id=>wwv_flow_api.id(7316695671441531428)
