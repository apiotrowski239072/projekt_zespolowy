...
begin
--   Manifest
--     PLUGIN: COM.FOS.CLIENTSIDE_CONDITION
--   Manifest End
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(7316612698764531362)
,p_plugin_type=>'DYNAMIC ACTION'
,p_name=>'COM.FOS.CLIENTSIDE_CONDITION'
,p_display_name=>'FOS - Client-side Condition'
,p_category=>'EXECUTE'
,p_supported_ui_types=>'DESKTOP:JQM_SMARTPHONE'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('DYNAMIC ACTION','COM.FOS.CLIENTSIDE_CONDITION'),'')
...
,p_reference_id=>51349213382717868824
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316612812382531366)
,p_plugin_id=>wwv_flow_api.id(7316612698764531362)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316613246606531368)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316613775107531369)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316614236701531369)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316614772094531369)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316615268743531370)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316615761723531370)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316616219542531370)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316616765804531370)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316617280046531370)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316617754085531371)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316618233719531371)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316618753606531371)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316619208588531371)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316619726200531371)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(7316620227358531372)
,p_plugin_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316620717310531372)
,p_plugin_id=>wwv_flow_api.id(7316612698764531362)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(7316612812382531366)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316621104904531373)
,p_plugin_id=>wwv_flow_api.id(7316612698764531362)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316621516982531373)
,p_plugin_id=>wwv_flow_api.id(7316612698764531362)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316621993538531373)
,p_plugin_id=>wwv_flow_api.id(7316612698764531362)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316622380975531373)
,p_plugin_id=>wwv_flow_api.id(7316612698764531362)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(7316621993538531373)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7316622733691531374)
,p_plugin_id=>wwv_flow_api.id(7316612698764531362)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(7316624361620531384)
,p_plugin_id=>wwv_flow_api.id(7316612698764531362)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(7316624772951531384)
,p_plugin_id=>wwv_flow_api.id(7316612698764531362)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(7316625195409531384)
,p_plugin_id=>wwv_flow_api.id(7316612698764531362)
