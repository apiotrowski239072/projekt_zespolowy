...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5265353766379549490)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5265354035497549490)
,p_plug_template_id=>wwv_flow_api.id(5265353766379549490)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5265354328243549490)
,p_plug_template_id=>wwv_flow_api.id(5265353766379549490)
,p_name=>'Sub Regions'
