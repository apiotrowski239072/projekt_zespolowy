...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5265383752315549505)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5265384089169549505)
,p_plug_template_id=>wwv_flow_api.id(5265383752315549505)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5265384361216549505)
,p_plug_template_id=>wwv_flow_api.id(5265383752315549505)
,p_name=>'Sub Regions'
