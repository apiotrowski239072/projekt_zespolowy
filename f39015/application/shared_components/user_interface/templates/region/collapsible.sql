...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5265364171204549495)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5265364487318549496)
,p_plug_template_id=>wwv_flow_api.id(5265364171204549495)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5265364768383549496)
,p_plug_template_id=>wwv_flow_api.id(5265364171204549495)
,p_name=>'Sub Regions'
