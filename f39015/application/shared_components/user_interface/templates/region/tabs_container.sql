...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5265390559981549508)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5265390802194549508)
,p_plug_template_id=>wwv_flow_api.id(5265390559981549508)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5265391106273549508)
,p_plug_template_id=>wwv_flow_api.id(5265390559981549508)
,p_name=>'Tabs'
